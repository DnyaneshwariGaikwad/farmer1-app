        ...
        <body>
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <main role="main" className="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"><div className="chartjs-size-monitor" style={{ position: "absolute", inset: "0px", overflow: "hidden", pointer: events = "none", visibility: "hidden", zindex: "-1" }}>
                        <div className="chartjs-size-monitor-expand" style={{ position: "absolute", left: "0", top: "0", right: "0", bottom: "0", overflow: "hidden", pointer: events = "none", visibility: "hidden", z: index = "-1" }}><div style={{ position: "absolute", width: "200%", height: "200%", left: "0", top: "0" }}></div></div></div>
                        ...
                        <Link
                            to="/SignIn"
                            className="btn btn-outline-primary d-inline float-end">
                            <i className="bi bi-person-plus-fill"></i>
                        </Link>


                        <canvas className="my-4 chartjs-render-monitor" id="myChart" width="843" height="356" style={{ display: "block", height: "285px", width: "675px" }}></canvas>
